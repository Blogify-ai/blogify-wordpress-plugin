...
Plugin URI:   https://blogify.ai/login?redirectTo=/dashboard/settings/wordpressorg-connect
...
add_action('init', 'register_blogify_post_type');

function register_blogify_post_type() {
    register_post_type(
    'blog',
    array(
        'labels' => array(
        ...
        'description' => 'Blogs generated by Blogify.ai',
        'public' => false,
    )
    );
}
...
function create_post_callback($request)
 {
     ...
     $post_data = array(
         ...
         'post_type' => 'blog', // You can use other post types as well
...
add_action('wp_head', 'wp_add_meta_html', 2);
